...
import { startCronJobs as startAICronJobs } from './services/cronService.js';
...
class TitanBot extends Client {
  ...
  async start() {
    try {
      ...
      startupLog('Initializing Neural Engine...');
      initAI();
  ...
  setupCronJobs() {
    ...
    startAICronJobs(this); // Initialize Daily AI Briefings
  }
